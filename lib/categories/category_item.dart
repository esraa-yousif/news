  ...
  Widget build(BuildContext context) {
   return Container(
      ...
      child:Column(
        ...
        children: [
        Image(image: AssetImage('assets/images/${categoryModel.imageName}'),
        ),
        Text(categoryModel.title,
         style: Theme.of(context).textTheme.titleLarge?.copyWith(color: AppTheme.white, fontWeight: FontWeight.bold)),
      ],),
    );
  }
}